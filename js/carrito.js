...
const productos = {
    producto1: {
      nombre: 'Hidronutritiva',
      precio: '10',
      descripcion: 'Crema suave y delicada para todo tipo de piel. Beneficios: Repone los componentes naturales del FNH que mantiene el balance de la piel',
      srcImg: '../img/crema_ultraRelax_480x480.jpg'
    },
    producto2: {
      nombre: 'Reparadora Antiage',
      precio: '13',
      descripcion: 'Nutre y aporta sustancias protectoras de la oxidación. Retiene agua y protege en climas y situaciones extremas. Contiene antioxidantes',
      srcImg: '../img/crema_cuidadoBasico_480x480.jpg'
    },
    producto3: {
      nombre: 'Nutritiva',
      precio: '15',
      descripcion: 'Además de proteger la membrana celular. Mejora la piel. Expandir una pequeña porción con maniobras de masaje acordes.',
      srcImg: '../img/crema_nutritiva_480x480.jpg'
    },
    producto4: {
      nombre: 'Suavizante',
      precio: '17',
      descripcion: 'Biológica cremosa. Ideal para pieles alípicas, átonas, con pérdida de densidad, perimenopausia y deshidratadas.',
      srcImg: '../img/crema_suavizante_480x480.jpg'
    }
